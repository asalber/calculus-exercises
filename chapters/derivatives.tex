...
%STATEMENT
{The radius of a spherical cell is equal to 5 $\mu$m, with a possible error of $0.2$ $\mu$m; compute the error in the measurement of the
area of the cell.
More generally, if the error in the measurement of the radius is $2\%$, what is the error in the value of the surface of
the cell?\\
