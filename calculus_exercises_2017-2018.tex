...
\input{extrema}
\input{taylor}
\input{separable_differential_equations}
\input{vectorial_derivatives}
\input{partial_derivatives}
\input{implicit_derivatives}
\input{implicit_derivatives_n_variables}
\input{taylor_n_variables}
\input{extrema_n_variables}
